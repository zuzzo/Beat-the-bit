...
func _ready() -> void:
    ...
    _register("lose_heart")
    _register("lose_coins")
    _register("discard_hand_card_1")
    _register("flip_equipment")
    _register("fail_hearts_conditional")
    _register("fail_even_or_odd")
    _register("penalty_code_router")
    _register("sacrifice_cost_router")
    _register("sacrifice_effect_router")
